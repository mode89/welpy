...
18. [ ] **Frame timing** — `wlr_presentation_time`: tell apps exactly when their frames appeared on screen, so video players and games can pace rendering smoothly and keep audio in sync with the picture.
